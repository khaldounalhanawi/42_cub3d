...
/*   Updated: 2026/01/29 12:40:15 by kalhanaw         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_player(t_game *game, t_init_data data)
{
	...
	game->player.plane_x = -game->player.dir_y * FOV * (WIDTH / (double)HEIGHT);
	game->player.plane_y = game->player.dir_x * FOV * (WIDTH / (double)HEIGHT);
